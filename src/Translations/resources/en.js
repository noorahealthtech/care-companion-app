export default {
  ...
  drawer: {
    ...
    screen3: 'ADD NEW SESSION',
    // screen4: 'PREVIOUS CLASSES',
    screen5: 'PAST SESSIONS',
    // screen6: 'ONLINE TRAINING',
    // screen7: 'CCP TOOLS',
    // screen8: 'INTERACTIVE GAMES',
  },
  markScreen: {
    ...
    option6: 'Inpatient',
    option7: 'Cardiology',
    newTitle: 'Patient | Caregiver information',
    patientInfo: 'PATIENT INFORMATION',
    patientNameTitle: 'Patient Name:',
    patientAgeTitle: 'Age:',
    categoryTitle: 'Category',
    genderTitle: 'Gender',
    categoryOption1: 'Presumptive TB Patient',
    categoryOption2: 'Confirmed TB Patient',
    genderOption1: 'Male',
    genderOption2: 'Female',
    genderOption3: 'Other',
    phoneNumberTitle: 'Phone Number:',
    phoneNumberOptional: 'Phone Number 2 (Optional):',
    patientAddress: 'Address',
    caregiverTitle: 'CAREGIVER INFORMATION',
    caregiverTitleName: 'Caregiver Name:',
    caregiverTypes1: 'Presumptive TB Patient Caregiver',
    caregiverTypes2: 'Confirmed TB Patient Caregiver',
    verificationTitle: 'VERIFICATION',
    verificationsubTitle: 'Has this patient/caregiver been register on the Care Companion App before?',
    verificationName: 'Verification',
    yes: 'YES',
    no: 'NO',
    VerifyNumber: 'Phone Number',
    VerifyID: 'Nikshay ID (Optional)',
    verifyDistrict: 'Village, District'

  },
  attendanceMarked: {
    button1: "VIEW PREVIOUS SESSIONS",
    button2: "VIEW PROFILE",
    heading: 'Your session has',
    been: 'been',
  ...
  previoussessions: {
    ...
    subtitle: 'You can',
    language: "view or edit",
    click: 'your previous session entries by clicking on them',
    marknew: 'EDIT CLASS DETAILS',
    button: "ADD NEW SESSIONS",
    button1: "ADD NEW SESSION",
  },
  editclass: {
    date: 'Date',
    time: 'Time',
