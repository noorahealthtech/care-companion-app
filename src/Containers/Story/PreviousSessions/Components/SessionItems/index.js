            ...
            >
                <View style={styles.heading}>
                    <View style={styles.details}>
                        <Text allowFontScaling={false} style={styles.date}>{moment(props.classDetails.session_date).format('DD')}</Text>
                        <Text allowFontScaling={false} style={styles.month}>{moment(props.classDetails.session_date).format('MMMM')}</Text>
                        <View style={styles.border} />
                        <Text allowFontScaling={false} style={styles.day}>{moment(props.classDetails.session_date).format('dddd')}</Text>
                    </View>
                    {/* <Text allowFontScaling={false} style={styles.time}>{tConvert(props.classDetails.class_date)}</Text> */}
